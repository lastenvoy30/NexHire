...
const InterviewPrep = () => {
    ...
    if (loading || !report) {
        return (
            <main className='loading-screen'>
                <h1>Building your customized experience...</h1>
            </main>
        )
    }
    ...
    return (
        <div className='interview-page'>
            <div className='interview-layout floating-card'>
                ...
                <div className='interview-body'>
                    ...
                    <aside className='interview-sidebar'>
                        ...
                        <div className='skill-gaps'>
                            <p className='skill-gaps__label'>Missing Capabilities</p>
